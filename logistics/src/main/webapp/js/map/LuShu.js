...
(function() {
     ...
     * lushu.speed();
     */
    LuShu.prototype.speed = function(speed) {//修改-添加获取、修改速度方法
      if($.isNumeric(speed)){
    ...
    LuShu.prototype.stop = function() {
        this.i = 0;
        this._marker&&this._marker.setPosition(this._path[this.i]);//修改-点击stop后mark回到起点
        this._fromStop = true;
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _addMarker: function(callback) {
            ...
            //marker.setAnimation(BMAP_ANIMATION_DROP); //修改-去掉mark跳入效果
            this._marker = marker;
        },
        /**
         * 添加上方overlay
